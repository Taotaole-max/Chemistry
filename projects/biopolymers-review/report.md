...
resistance to degradation, so improving one property worsens the other two. And a reported molecular
weight is meaningful only when the measurement method is reported with it. A natural-rubber/SBR case
